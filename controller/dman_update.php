...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	if(count($errors) === 0){
        ...
        $password1 = mysqli_real_escape_string($conn, $_POST['password1']);
			...
			$sql = "update `dman` set username ='$varr', fullname='$fullname', email = '$email', mobile = '$mobile', gender='$gender', image ='$imagename', password = '$password1' where username = '$varr' ";
...
<head>
    ...
    <title>DeliveryMan Update Profile</title>
</head>
<body>
