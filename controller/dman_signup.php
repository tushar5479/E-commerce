...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	if(count($errors) === 0){
		...
		$search_query = "SELECT * FROM dman WHERE username = '$username'";
		...
		if($count >0 ){
			...
			$sql = "INSERT INTO dman (fullname, username, email, mobile, gender, image, password) VALUES ('$fullname','$username','$email','$mobile','$gender','$imagename','$password1')";
            ...
            echo '<script>window.location="dman_signup.php"</script>';
...
<body>
    ...
    <h3 style="color: white;">DeliveryMan Sign Up</h3>
        ...
        <p style="color: white;">Already a DeliveryMan ? <a href = "dman_login.php">LogIn</a></p>
	</form>
