...
$sql = "SELECT* FROM `sellers` where username ='$username' && password= '$password'";
...
<body>
    ...
    <h3 style=" color: white">Seller Login</h3>
   <!-- User Name -->
   ...
   <div>
    ...
    <label class="form_check">
        ...
        <p>Register youself as a seller!<a href = "sellersignup.php">SignUp</a></p>
...
extract($_REQUEST);
$file = fopen("../view/txt_files/seller_login_details.txt","a");
fwrite($file, "Name: ");
