...
$errors = array();
  ...
  $sql = "Select * from `sellers` where username = '$varr'";
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	if(count($errors) === 0){
        ...
        $password1 = mysqli_real_escape_string($conn, $_POST['password1']);
			...
			$sql = "update `sellers` set username ='$varr', fullname='$fullname', email = '$email', mobile = '$mobile', gender='$gender', image ='$imagename', password = '$password1' where username = '$varr' ";
            ...
            echo '<script>window.location="../controller/seller_update.php"</script>';
            header("Location: ../view/sellerdash.php");
		}
	}
...
<head>
    ...
    <title>Seller Update Profile</title>
...
<body>
    ...
    <!-- <p><a href="seller_profile.php">go back</a></p>
