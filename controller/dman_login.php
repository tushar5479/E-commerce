...
$sql = "SELECT* FROM `dman` where username ='$username' && password= '$password'";
...
if($count==1){
  ...
  header("Location: ../view/dmandash.php");
}else{
    echo '<script>alert("!!! Please check your username and password !!!")</script>';
    echo '<script>window.location="dman_login.php"</script>';
}
...
<body>
    ...
    <h3 style=" color: white">DeliveryMan Login</h3>
   <!-- User Name -->
   ...
   <div>
    ...
    <label class="form_check">
        ...
        <p>Register youself as a DeliveryMan ! <a href = "dman_signup.php">SignUp</a></p>
...
extract($_REQUEST);
$file = fopen("../txt_files/deliveryman_login_details.txt","a");
fwrite($file, "Name: ");
